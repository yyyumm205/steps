...
更新日期：2026-09-19。状态：总纲已确认，T1 准备版补充真实运行与 BLE 修复；Q01/Q02 待确认，Q03 已确认。分支：`codex/free-living-session-spec`。第 1–4 节保留 `29486e6` 当时的文档审阅依据；第 5 节为初版 T1，第 6 节起记录后续改动。历史段落中的版本和决策状态按当时日期理解，当前状态以 requirements 第 6 节为准。原始资料和本地配置保留。
