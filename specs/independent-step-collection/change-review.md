...
当前增量（2026-09-19）：[总纲](../../CONSTITUTION.md)升至2.1.0，将按用户任务交付、技术与运行证据分层、依赖驱动的自主推进及按风险验证固化为长期规则。阶段路线与现有T2-P至真实闭环的顺序对齐，文档职责归一；使命、实验操作、数据契约和Q01/Q02状态保持原义。本次工作流修订仅涉及总纲与现有规格，运行验收由对应实现继续完成。
